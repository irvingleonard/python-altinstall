# SLES 15.6 and compatibles
###### (currently using OpenSUSE Leap 15.6)
...
`docker build -t python-altinstall:sles15.6 .`

Then, to build the latest version:

`docker run --rm --volume "$PWD"/releases:/root/rpmbuild/SRPMS --volume "$PWD"/releases:/root/rpmbuild/RPMS python-altinstall:sles15.6 python310-altinstall.spec`
