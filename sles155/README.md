# SLES 15.5 and compatibles
###### (currently using OpenSUSE Leap 15.5)
...
`docker build -t python-altinstall:sles15.5 .`

Then, to build the latest version:

`docker run --rm --volume "$PWD"/releases:/root/rpmbuild/SRPMS --volume "$PWD"/releases:/root/rpmbuild/RPMS python-altinstall:sles15.5 python310-altinstall.spec`
