# openEuler 22.03 LTS and compatibles
...
`docker build -t python-altinstall:oe2203 .`

Then, to build the latest version:

`docker run --rm --volume "$PWD"/releases:/root/rpmbuild/SRPMS --volume "$PWD"/releases:/root/rpmbuild/RPMS python-altinstall:oe2203 python310-altinstall.spec`
